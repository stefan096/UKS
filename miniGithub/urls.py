...
urlpatterns = [
    ...
    path('projects/<int:project_id>/labels/<int:label_id>/show/<int:action>', label_details_action, name='label_details_action'),
    ...
    path('projects/<int:project_id>/problems/<int:milestone_id>/show/<int:action>', milestone_details_action,
